...
def overlay_heatmap_to_basic_image(label, config_label, _class, omission_classes, fg_positions, dataset_size):
    ...
    precision_heatmap = np.load("/media/mriva/LaCie/SATANN/synthetic_fine_segmentation_results/tests/reference_position/results_{}/dataset_{}/{}/ref{}on1_omission{}_precision.npy".format(label, dataset_size, config_label, _class, omission_classes)) 
    recall_heatmap = np.load("/media/mriva/LaCie/SATANN/synthetic_fine_segmentation_results/tests/reference_position/results_{}/dataset_{}/{}/ref{}on1_omission{}_recall.npy".format(label, dataset_size, config_label, _class, omission_classes)) 
...
overlay_heatmap_to_basic_image("seg", "T_hard_noise", 1, [2], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 10000)
overlay_heatmap_to_basic_image("seg", "T_hard_noise", 1, [3], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 10000)
...
overlay_heatmap_to_basic_image("seg", "T_hard_noise", 1, [2], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 1000)
overlay_heatmap_to_basic_image("seg", "T_hard_noise", 1, [3], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 1000)
...
overlay_heatmap_to_basic_image("seg", "T_hard_noise", 1, [2], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 100)
overlay_heatmap_to_basic_image("seg", "T_hard_noise", 1, [3], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 100)
...
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [2], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 50000)
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [3], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 50000)
...
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [2], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 5000)
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [3], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 5000)
...
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [2], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 10000)
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [3], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 10000)
...
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [2], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 1000)
overlay_heatmap_to_basic_image("strict", "T_strict_noise", 1, [3], [(0.65, 0.3), (0.65, 0.7), (0.35, 0.7)], 1000)
