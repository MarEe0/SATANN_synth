...
if __name__ == "__main__":
    ...
    convergence_lists = [[
                            ...
                            [True, True, True, False, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True]
                        ],
                        [
                            [True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True],
        ...
        for experimental_config, config_convergence in zip(experimental_configs, convergence_list):
            ...
            for reference_class in [int(sys.argv[1])]:
                ...
                for _class in crit_classes:
                    ...
                    plt.axis("off")
                    plt.savefig("/home/mriva/Recherche/PhD/SATANN/SATANN_synth/tests/reference_position/results_seg/dataset_{}/{}/ref{}on{}_omission{}_recall.png".format(dataset_size, experimental_config["label"], reference_class, _class, omission_classes), bbox_inches="tight")
                    plt.clf()
                    np.save("/home/mriva/Recherche/PhD/SATANN/SATANN_synth/tests/reference_position/results_seg/dataset_{}/{}/ref{}on{}_omission{}_recall.npy".format(dataset_size, experimental_config["label"], reference_class, _class, omission_classes), recall_heatmap)
                    ...
                    mkdir("/home/mriva/Recherche/PhD/SATANN/SATANN_synth/tests/reference_position/results_seg/dataset_{}/{}".format(dataset_size, experimental_config["label"]))
                    plt.axis("off")
                    plt.savefig("/home/mriva/Recherche/PhD/SATANN/SATANN_synth/tests/reference_position/results_seg/dataset_{}/{}/ref{}on{}_omission{}_precision.png".format(dataset_size, experimental_config["label"], reference_class, _class, omission_classes), bbox_inches="tight")
                    plt.clf()
                    np.save("/home/mriva/Recherche/PhD/SATANN/SATANN_synth/tests/reference_position/results_seg/dataset_{}/{}/ref{}on{}_omission{}_precision.npy".format(dataset_size, experimental_config["label"], reference_class, _class, omission_classes), precision_heatmap)
